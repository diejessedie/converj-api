...
RSpec.describe 'Events API', type: :request do
  ...
  describe 'POST /events' do
    # valid payload
    let(:valid_attributes) { { name: 'Muddy Water', description: 'the 1st of many',
      date: 'Sun, 03 Feb 2019 04:05:06 +0000', location: '1001 Maine Blvd',
      link: 'www.byebyebirdy.com' } }

    context 'when the request is valid' do
      before { post '/events', params: valid_attributes }

      it 'creates a event' do
        expect(json['name']).to eq('Muddy Water')
      end
    ...
    context 'when the request is invalid' do
      #invalid payload
      before { post '/events', params: { description: 'the 1st of many',
        date: 'Sun, 03 Feb 2019 04:05:06 +0000', location: '1001 Maine Blvd',
        link: 'www.byebyebirdy.com' } }
  ...
  describe 'PUT /events/:id' do
    let(:valid_attributes) { { name: 'The Bug Out' } }
