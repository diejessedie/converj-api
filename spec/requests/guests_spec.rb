...
RSpec.describe 'Guests API', type: :request do
  ...
  describe 'POST /guests' do
    # valid payload
    let(:valid_attributes) { { name: 'Gee Patti', phone_number: '+13144970354',
      subscribed: true } }
    ...
    context 'when the request is valid' do
      ...
      it 'creates a guest' do
        expect(json['name']).to eq('Gee Patti')
      end
    ...
    context 'when the request is invalid' do
      #invalid payload
      before { post '/guests', params: { phone_number: '+13144970354',
        subscribed: true } }
  ...
  describe 'PUT /guests/:id' do
    let(:valid_attributes) { { name: 'Boo Boo da Fool' } }
